...
import 'package:sjgtv/src/movie/movie_model.dart';
import 'package:sjgtv/src/tag/tag_model.dart';
import 'package:sjgtv/src/movie/search_page.dart';
import 'package:sjgtv/src/app/theme/app_theme.dart';
import 'package:sjgtv/src/source/source_manage_page.dart';
import 'package:sjgtv/src/movie/focusable_movie_card.dart';
...
class _MovieHomePageState extends ConsumerState<MovieHomePage> {
  ...
  Future<void> _fetchTags() async {
    try {
      final ApiListResultModel<TagModel> result = await _apiService.getTags();
      if (!mounted) return;
      if (result.isSuccess && result.data != null) {
        setState(() {
          _tabs = result.data!.map((TagModel tag) => tag.name).toList();
